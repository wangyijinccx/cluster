...
public class DateUtil {
    ...
    public static Timestamp getNowTimestamp() {
        String stampStr = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS").format(System.currentTimeMillis());
     ...
     * @return
     */
    public static String getSpecifiedDayTimeAfter(String specifiedDay) {
        Calendar c = Calendar.getInstance();
        Date date = null;
        try {
    ...
    public static String getSpecifiedDayTimeBefore(String specifiedDay) {
        // SimpleDateFormat simpleDateFormat = new
        // SimpleDateFormat("yyyy-MM-dd");
        Calendar c = Calendar.getInstance();
        Date date = null;
        ...
        String dayBefore = new SimpleDateFormat("yy-MM-dd HH:mm:ss").format(c.getTime());
        return dayBefore;
    }
    ...
    public static Date getSpecifiedDayTimeAfter(Date date) {
        Calendar c = Calendar.getInstance();
        c.setTime(date);
        int day = c.get(Calendar.DATE);
        c.set(Calendar.DATE, day + 1);
    ...
    public static Date getSpecifiedDayTimeBefore(Date date) {
        Calendar c = Calendar.getInstance();
        c.setTime(date);
        int day = c.get(Calendar.DATE);
        c.set(Calendar.DATE, day -1);
    ...
    public static void main(String[] args) {
        try {
            Date date = convertStringToDate("2015-02-20 09:42:30");
            System.out.println(getDayOfMonth(date));
            System.out.println(getOnlyTime(new Date()));
        } catch (ParseException e) {
