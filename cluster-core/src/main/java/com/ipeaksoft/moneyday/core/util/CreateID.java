...
public class CreateID {
	...
	public static void main(String[] strs){
		System.out.println(generate()+".."+generate6());
		System.out.println(generate()+".."+generate6());
		System.out.println(generate()+".."+generate6());
		System.out.println(generate()+".."+generate6());
		System.out.println(generate()+".."+generate6());
		...
		System.out.println(generate()+".."+generate6());
		System.out.println(generate()+".."+generate6());
//		System.out.println(generate()+".."+generate9());
	}
	/**
	...
	final public synchronized static String generate() {
		...
		return sb.append(str.charAt(pixOne)).append(str.charAt(pixTwo))
				.append(str.charAt(pixThree)).append(str.charAt(pixFour))
				.toString();
	}
	 ...
	 * 随机创建数据库6位ID
	 * 
	 * @return String 6位随机数ID
	 */
	public synchronized static String generate6() {
	    
	    int n = (int) (Math.random() * 600000) + 100000;
	    return n + "";
	}
