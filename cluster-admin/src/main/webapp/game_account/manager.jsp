	...
	<div class="container-fluid">
		<div class="row border-bottom padding-top-15 ">
			<div class="col-xs-2 text-left">
				<ol class="breadcrumb">
					<li><a href="#">游戏账号</a></li>
					<li><a href="#" class="active">游戏账号管理</a></li>
				</ol>
			</div>
		</div>
					...
					var table = $('#datalist').dataTable(
							{
								...
								"ajax" : {
									"url" : "${pageContext.request.contextPath}/game/account/data_load",
									"dataType" : "json",
									"method" : "POST"
								},
								"columns" : [
										...
										},
										{
											...
											"render" : function(data, type, row) {
												return '<a type="button" class="btn btn-primary btn-xs" href="${pageContext.request.contextPath}/game/account/published?id=' + row.id + '">查看</a>'
											}
										}
