					...
					<div class="form-group">
						...
						<div class="col-xs-3 s">
							<input name="name" type="text" class="form-control"
								id="name" placeholder="游戏名称" required="required">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-xs-3 s">
							...
							<input type="text" class="form-control" name="gameTime"
								id="gameTime"
								onFocus="WdatePicker({dateFmt:'HH:mm:ss',alwaysUseStartDate:true})" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-xs-3 s">
							<input name="bundleid" type="text" class="form-control"
								id="bundleid" placeholder="bundleId" required="required">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-xs-3 s">
							<input name="version" type="text" class="form-control"
								id="version" placeholder="游戏版本" required="required">
						</div>
					</div>
