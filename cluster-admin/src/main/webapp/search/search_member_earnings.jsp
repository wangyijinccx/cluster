...
<li><a href="${pageContext.request.contextPath}/search/member_list">成员查询</a></li>
 <li><a href="${pageContext.request.contextPath}/search/member_day_task" >单日任务</a></li>
  <li><a href="#" class="active">成员收益</a></li>
</ol>
            </div>
        ...
        <div class="row border-bottom padding-15-tb">
            <div class="col-xs-12">2014/11/25  XXX类用户收益</div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var table = $('#datalist').dataTable({
                ...
                "ajax": {
                    "url": "${pageContext.request.contextPath}/search/data_member_earnings",
                    "data": function (d) {
                ...
                "columns": [
                   ...
                   
                    {
                        "render": function (data, type, row) {
                            return '<a type="button" class="btn btn-primary btn-xs" href="${pageContext.request.contextPath}/search/member_detail">更多</a>';
                        }
                    }
                ],
                "oLanguage": {
