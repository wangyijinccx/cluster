			...
			<div class="row padding-15-tb">
				<div class="col-xs-12">
					<form id="form_task" class="form-horizontal"
						action="${pageContext.request.contextPath}/task/normal/add">
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-xs-7">
								<label class="radio-inline"> <input type="radio"
									name="enable" id="inlineRadio1" value="Y" checked="checked">是
								</label> <label class="radio-inline"> <input type="radio"
									name="enable" id="inlineRadio2" value="N"> 否
								</label>
						...
						<div class="form-group">
							...
							<div class="col-xs-7">
								<label class="radio-inline"> <input type="radio"
									name="priority" id="inlineRadio1" value="0" checked="checked">普通
								</label> <label class="radio-inline"> <input type="radio"
									name="priority" id="inlineRadio2" value="1"> 高级
								</label>
