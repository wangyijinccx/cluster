...
<body>
			...
			<div class="row padding-15-tb">
				<div class="col-xs-12">
					<form id="account_form" class="form-horizontal" role="form"
						action="${pageContext.request.contextPath}/notice/edit_do">
						<input type="hidden" name="id" value="${noticeRecord.id}"/>
						<div class="form-group">
							<label for="title" class="col-sm-2 control-label">标题</label>
							<div class="col-sm-4">
								<input type="text" class="form-control" id="title"
									name="title" placeholder="请输入标题" value="${noticeRecord.title}"/>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-xs-4">
								<div>
									<div class="col-sm-10 p0" style=" padding-left: 0px; ">
										<input class="form-control " type="text" name="img" id="img" value="${noticeRecord.img}" />
									</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-4">
							<textarea rows="50" maxlength="200" cols="100" name="summary" id="summary" style="width: 488px; height: 126px">${noticeRecord.summary}</textarea>
							</div>
						</div>
	...
	<script type="text/javascript">
		$(function() {
			...
			ue.ready(function() {
    //设置编辑器的内容
    ue.setContent('${noticeRecord.content}');
