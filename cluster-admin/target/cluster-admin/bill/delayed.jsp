	...
	<div class="container-fluid">
		<div class="row border-bottom padding-top-15 ">
			<div class="col-xs-2 text-left">
				<ol class="breadcrumb">
					<li><a href="#">兑换</a></li>
					<li><a href="#" class="active">推迟订单</a></li>
				</ol>
			</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			var table = $('#datalist').dataTable({
				...
				"ajax" : {
					"url" : "${pageContext.request.contextPath}/bill/delayed/data_load",
					"data" : function(d) {
				...
				"columns" : [ {
					...
					"render" : function(data, type, row) {
						return '<a type="button" class="btn btn-primary btn-xs" href="${pageContext.request.contextPath}/bill/delayed/delaying?id=' + row.id + '">查看</a>';
					}
				} ],
				"oLanguage" : {
