						...
						"columns" : [
								...
								},
								{
									"render" : function(data, type, row) {
										...
										return ' <a type="button" class="btn btn-primary btn-xs" href="${pageContext.request.contextPath}/account/' + url + '?pid=' + row.id
												+ '">成员</a> <a type="button" class="btn btn-Info btn-xs" href="${pageContext.request.contextPath}/account/AccountDetail?id=' + row.id + '">查看信息</a>';
									}
								}
