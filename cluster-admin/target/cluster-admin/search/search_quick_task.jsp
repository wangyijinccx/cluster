	...
	<main>
        ...
        <div class="row border-bottom padding-top-15 ">
            <div class="col-xs-2 text-left">
                <ol class="breadcrumb">
  <li><a href="#">查询</a></li>
  <li><a href="#" class="active">快速任务</a></li>
        ...
        <div class="row border-bottom padding-15-tb">
            <div class="col-xs-4 line-height-34 ">快速任务累计收益： ${income} 金币</div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var table = $('#datalist').dataTable({
                ...
                "ajax": {
                    "url": "${pageContext.request.contextPath}/search/quicksearch_list",
                    "data": function (d) {
                ...
                "columns": [
                    ...
                    
                    {
                        ...
                        console.info(row);
                            ...
                            return '<a type="button" class="btn btn-primary btn-xs" href="${pageContext.request.contextPath}/search/quick_task_list?day='+row.day+'">查看</a>';
                        }
                    }
                ],
                "oLanguage": {
