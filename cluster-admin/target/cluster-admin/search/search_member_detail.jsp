			...
			<div class="tab-content">
				<form class="tab-pane active form-horizontal" id="home">
					...
					<div class="form-group">
						...
						<div class="col-xs-3" id="createTime">
					...
					<div class="form-group">
						<label for="username" class="col-xs-3  control-label">竞品信息：</label>
						<div class="col-xs-6" id="competitor">
							<c:forEach items="${competitorList }" var="competitor">
								<p class="form-control-static" id="competitorName">${competitor.appname}&nbsp;${competitor.urlscheme}</p>
							</c:forEach>
						</div>
					</div>
				...
				<div class="tab-pane" id="profile">
					<div class="row border-bottom padding-5">
						<div class="col-xs-2">快速收益：80000 金币</div>
						<div class="col-xs-2">常规收益：80000 金币</div>
						<div class="col-xs-2">累计兑换：80000 金币</div>
						<div class="col-xs-2">账户余额：80000 金币</div>
					</div>
					<table id="datalist"
	...
	<script>
		$(function() {
			...
			var table = $('#datalist').dataTable({
				...
				"ajax" : {
					"url" : "${pageContext.request.contextPath}/account/findTaskByUser",
					"data" : function(d) {
						d.mobile = $
						{
							userInfo.mobile
